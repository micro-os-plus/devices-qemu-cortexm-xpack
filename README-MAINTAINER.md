...
Determine the upstream version (like `7.0.1`) and eventually update the
`package.json` file; the format is `7.0.1-pre`.
...
- add a new entry like _\* v7.0.1_
...
- `npm dist-tag add @micro-os-plus/devices-qemu-cortexm@7.0.1 latest`
- `npm dist-tag ls @micro-os-plus/devices-qemu-cortexm`
